...
$(function(){
	...
	$(".panel-body a").click(function(){
		...
		if(!bool){
			var title='<li id="tabPanel_'+id+'"><a id="tab_'+id+'" href="#panel_'+id+'" data-toggle="tab">'+o.text()+' <b onclick="comm.closeTab(this,\''+id+'\')" style="color:blue;cursor:pointer;" title="关闭">X</b></a></li>';
